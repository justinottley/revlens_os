...
class RlpQtWsClient(QtCore.QObject):
    '''
    ...
    def __init__(self, url, *args, **kwargs):
        ...
        self.__url_hostname = url_parts.netloc.split(':')[0]
        ...
        self._wsclient.clientConnected.connect(self.on_connected)
        self._wsclient.clientDisconnected.connect(self.on_disconnected)
    ...
    def on_disconnected(self, url, msg):
        print('{}: disconnected - {}'.format(url, msg))
        self.connected = False
