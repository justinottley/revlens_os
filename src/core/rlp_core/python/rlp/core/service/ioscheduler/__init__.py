...
class IOQueue(object):
    ...
    def pop_next_task(self):
        ...
        self.LOG.debug('{} - pop next task: {}'.format(self.name, run_id))
    ...
    def finalize(self, run_id):
        ...
        self.LOG.info('{} - Finalizing: {}'.format(self.name, run_id))
    ...
    def append(self, run_id, payload):
        ...
        msg = '{} - append {} {}'.format(self.name, run_id, payload['kwargs'])
        ...
        self.LOG.progress(run_id, msg, progress_info)
...
class IOScheduler(object):
    ...
    def register_queue(self, size=1, *args, **kwargs):
            ...
            while self.has_pending_tasks():
                ...
                for q_name, queue in self.queues.items():
                    ...
                    if queue.has_pending_tasks():
                        ...
                        # print('Got pending tasks for {}'.format(q_name))
