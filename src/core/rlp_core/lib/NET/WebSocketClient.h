...
signals:
    void clientConnected(); // re-emitted from internal QWebSocket signal for public consumption
    void clientDisconnected(QString url, QString errMsg); // re-emitted from internal QWebSocket signal for public consumption
    void tryReconnect(QString url);
...
public slots:
    ...
    QString formatMessage(QVariantMap msgObj);
...
protected:
    ...
    QMap<QString, CoreNet_RPCFuture*> _callbackMap;
