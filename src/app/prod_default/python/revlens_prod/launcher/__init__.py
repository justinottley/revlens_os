...
def init_plugins():
    ...
    # from . import revlens_interface
    # sys.modules['revlens'] = revlens_interface
    # sys.modules['revlens.plugin'] = revlens_interface.plugin
    # sys.modules['revlens.media'] = revlens_interface.media
    # sys.modules['revlens.media.locator'] = revlens_interface.media_locator
    # sys.modules['revlens.keyboard'] = revlens_interface.keyboard
