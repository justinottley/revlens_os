...
def startup():
    ...
    RlpUtil.APPGLOBALS.insert('prod_data', ProdDataObjectFactory)
    ...
    revlens.plugin.register(
        ...
        {
            'name': 'Files',
            'pyitem': 'revlens_prod.panel.files'
        }
    )
    ...
    revlens.plugin.register(
        revlens.plugin.PLUGIN_GRID_ROW_WIDGET,
        {
            'name': 'media',
            'plugin': RevlensGui.GUI_ROWMEDIAWIDGETPLUGIN_OBJ
        }
    )
