...
class LibraryPanel(RlpGui.GUI_ItemBase):
    ...
    def __init__(self, parent):
        ...
        self.playlistView = ReviewMainWidget(self) # DataSource must be set by a plugin
        self.playlistView.setPos(0, 50)
        self.playlistView.hideItem()
        ...
        rbtn = self.navGroup.addButton(self.PLAYLIST_LABEL, ':feather/list.svg', iconSize=20, view=self.playlistView)
        ri = rbtn.svgIcon()
        ri.setYOffset(5)
        ri.setXOffset(4)
        ri.setHeight(30)
        ...
        self.navGroup.selectButton(self.PLAYLIST_LABEL)
