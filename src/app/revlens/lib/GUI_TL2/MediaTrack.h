...
public slots:
    ...
    void onVisibilityChanged(QVariantMap md=QVariantMap());
    void onMediaRemoved(DS_NodePtr node, QString trackUuidStr, qlonglong startFrame, bool doSync);
    void onMediaEnabledChanged(QUuid nodeUuid, bool isEnabled);
    void onMediaSelectionChanged(QUuid nodeUuid, bool isSelected);
