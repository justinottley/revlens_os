...
public:
    ...
    bool registerTimelineView(GUI_TL2_View* view);
    bool deregisterTimelineView(GUI_TL2_View* view);
...
public slots:
    ...
    GUI_TL2_ViewBase* getFocusedTimelineView() { return _focusedView; }
    void setFocusedTimelineView(GUI_TL2_ViewBase* view) { _focusedView = view; }
