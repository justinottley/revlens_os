...
class REVLENS_GUI_TL2_API GUI_TL2_View : public GUI_TL2_ViewBase { // public GUI_ItemBase, public DS_SyncProbe {
    Q_OBJECT
...
public:
    ...
    QThreadPool* tpool() { return _tpool; }
...
public slots:
    ...
    GUI_ItemBase* timelineArea() { return _timelineArea; }
    ...
    GUI_TL2_Bookends* bookends() { return _bookends; }
    GUI_TL2_Splitter* splitter() { return _splitter; }
...
public slots:
    ...
    void onScrollWheelDelta(int delta);
...
public slots:
    ...
    void onTrackDataChanged(QString evtName, QString trackUuidStr, QVariantMap info);
