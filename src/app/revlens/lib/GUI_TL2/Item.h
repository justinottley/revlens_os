...
public slots:
    ...
    void setSelected(bool selected) { _isSelected = selected; updateItem(); }

    bool isItemEnabled() { return _isEnabled; }
    void setItemEnabled(bool isEnabled) { _isEnabled = isEnabled; updateItem(); }
