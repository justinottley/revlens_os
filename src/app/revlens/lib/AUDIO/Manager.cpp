...
{
    #ifdef SCAFFOLD_IOS
    RLP_LOG_WARN("IOS detected, disabling")
    _enabled = false;
    #endif

    #ifdef SCAFFOLD_WASM
    RLP_LOG_WARN("WASM detected, disabling")
    _enabled = false;
    #endif
...
void
AUDIO_Manager::onMediaDataReady(QString dataType, QVariantMap data)
{
