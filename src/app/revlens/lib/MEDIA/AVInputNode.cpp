    ...
    DS_Node("MEDIA_AVInput", properties)
{
    ...
    audioInfo.insert("audio.output.bit_depth", ag->value("audio.output.bit_depth"));
    audioInfo.insert("audio.output.channel_count", ag->value("audio.output.channel_count"));
