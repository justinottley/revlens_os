...
signals:
    ...
    void mediaDataReady(QString evtName, QVariantMap evtInfo);
...
public:
    ...
    DS_ControllerPtr controller() { return _controller; }
...
public slots:
    ...
    QVariantMap identifyMedia2(QVariantMap mediaInput);

    void onMediaDataReady(QString dataType, QVariantMap data);
    void onLoadComplete(QUuid uuid, QString dataType);
