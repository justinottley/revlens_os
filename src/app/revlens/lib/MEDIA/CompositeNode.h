...
public:
    ...
    void readVideo1(DS_TimePtr timeInfo, DS_BufferPtr destFrame, bool postUpdate = true);
...
public slots:
    ...
    // TODO FIXME: DEPRECATE, switched to per-display
    bool setInputEnabled(bool idx, bool enabled);
    QVariantList getInputInfo();
