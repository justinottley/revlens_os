...
public slots: // Public API
    ...
    void setDisplayEnabled(bool isEnabled);
    void enable() { setDisplayEnabled(true); } // for easier use via QTimer::singleShot
    void disable() { setDisplayEnabled(false); } // for easier use via QTimer::singleShot
    bool isDisplayEnabled() { return _enabled; }
