...
public:
    ...
    void* data(int index) { return _bufferList.at(index)->data(); }
    ...
    virtual DS_BufferPtr getBuffer(int index) { return _bufferList.at(index); }
    virtual DS_BufferList getBufferList() { return _bufferList; }
    virtual void clearAuxBufferList() { _bufferList.clear(); }
    virtual void setAuxBufferList(DS_BufferList bufList) { _bufferList = bufList; }
...
protected:
    ...
    DS_BufferList _bufferList; // primary frame buffer list
