    ...
    GUI_ItemBase(parent)
{
    ...
    _trackListButton->setSvgIconPath(":/feather/chevron-down.svg", 20);
    ...
    _posButton->setSvgIconPath(":/feather/chevron-down.svg", 20);
...
GUI_ItemLoader::onLoadRequested(QVariantMap /* metadata */)
{
    ...
    QVariantList mediaList = {_loadInfo};


    MEDIA_Factory* factory = MEDIA_Factory::instance();
    factory->appendMedia(_loadInfo, track.get());
