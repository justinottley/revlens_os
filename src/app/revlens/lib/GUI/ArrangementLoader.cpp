...
RLP_SETUP_LOGGER(prod, GUI, ArrangementLoader)

// void
// GUI_ArrangementLoader::init(GUI_PanePtr parent, GUI_View* view, CoreCntrl_ControllerBase* cntrl)
// {
//     // RLP_LOG_DEBUG("")
// }
...
bool
GUI_ArrangementLoader::_loadArrangement(GUI_Pane* rp, QVariantMap paneInfoIn)
{
    ...
    if (paneInfoIn.contains("tabHeaderVisibility"))
    {
        ...
        pview->setTabHeadersVisible(tabvis);
    }
...
bool
GUI_ArrangementLoader::loadArrangement(GUI_Pane* rp, QVariantMap paneInfoIn)
{
