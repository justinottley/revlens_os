...
RLP_SETUP_LOGGER(revlens, GUI_VIEW, LoadOverlay)

GUI_VIEW_LoadOverlay::GUI_VIEW_LoadOverlay(GUI_ItemBase* parent):
    GUI_ItemBase(parent)
{
...
void
GUI_VIEW_LoadOverlay::setMousePos(QPointF pos)
{
    // RLP_LOG_DEBUG("")
...
int
GUI_VIEW_LoadOverlay::getNumMediaTracks()
{
...
int
GUI_VIEW_LoadOverlay::requestedAction()
{
...
DS_TrackPtr
GUI_VIEW_LoadOverlay::requestedTrack()
{
    DS_SessionPtr sess = CNTRL_MainController::instance()->session();
...
QRectF
GUI_VIEW_LoadOverlay::boundingRect() const
{
...
void
GUI_VIEW_LoadOverlay::paint(GUI_Painter* painter)
{
