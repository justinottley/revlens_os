...
def _init_login():
    ...
    serverMgr = CNTRL.getServerManager()
    RlpIOServiceClient.CNTRL_SERVICE = serverMgr
    ...
    if os.getenv('RLP_APP_PLATFORM') == 'ios':
        loginInfo['site_url'] = 'ws://192.168.1.68:8003'

    # loginInfo['site_url'] = 'ws://127.0.0.1:8003'

    rlpClient = SiteWsClient.init(loginInfo['site_url'])

    serverMgr.setWebSocketClient(rlpClient._wsclient) # TODO FIXME DEPRECATE
    serverMgr.registerNamedClient('site', rlpClient._wsclient)
