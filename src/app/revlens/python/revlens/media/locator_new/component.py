...
from . import MediaLocator

class ComponentMediaLocator(MediaLocator):
    '''
    TODO FIXME: revisit this, the component thing is really to support different 
    formats per clip, might be a better way to do this
    '''
