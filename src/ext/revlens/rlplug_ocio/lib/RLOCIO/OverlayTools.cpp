    ...
    GUI_ItemBase(parent)
{
    ...
    _inputSel->setSvgIconPath(":feather/image.svg", 15);
    ...
    _displaySel->setSvgIconPath(":feather/monitor.svg", 15);
    ...
    // _exposureMinusBtn = new GUI_SvgButton(":feather/minus.svg", this, 25);
    // _exposureMinusBtn->icon()->setBgColour(QColor(180, 180, 180));
    // _exposureMinusBtn->setPos(60, parent->height());

    // _exposurePlusBtn = new GUI_SvgButton(":feather/plus.svg", this, 25);
    ...
    // _gammaMinusBtn = new GUI_SvgButton(":feather/minus.svg", this, 25);
    // _gammaMinusBtn->icon()->setBgColour(QColor(180, 180, 180));
    // _gammaMinusBtn->setPos(60 + (parent->width() / 2), parent->height() - 20);

    // _gammaPlusBtn = new GUI_SvgButton(":feather/plus.svg", this, 25);
    ...
    _chanR = new GUI_SvgButton(":feather/circle.svg", this, 24);
    ...
    _chanG = new GUI_SvgButton(":feather/circle.svg", this, 24);
    ...
    _chanB = new GUI_SvgButton(":feather/circle.svg", this, 24);
