...
OpenGLBuilderRcPtr OpenGLBuilder::Create(const GpuShaderDescRcPtr & shaderDesc, unsigned programId)
{
    return OpenGLBuilderRcPtr(new OpenGLBuilder(shaderDesc, programId));
}

OpenGLBuilder::OpenGLBuilder(const GpuShaderDescRcPtr & shaderDesc, unsigned programId)
...
OpenGLBuilder::~OpenGLBuilder()
{
    ...
    /*
     * SKIP THIS, REST OWNED BY QT OBJECTS
     *
    if(m_fragShader)
    {
