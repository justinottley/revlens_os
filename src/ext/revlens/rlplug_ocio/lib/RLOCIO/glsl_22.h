...
public:
    ...
    static OpenGLBuilderRcPtr Create(const GpuShaderDescRcPtr & gpuShader, unsigned programId);
...
OpenGLBuilder(const GpuShaderDescRcPtr & gpuShader, unsigned programId); // =glCreateProgram()
