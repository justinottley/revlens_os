...
from .tools import BrushToolSettings
...
class AnnotationToolbarHandler(RlpGui.GUI_ItemBase):
    ...
    def __init__(self, viewer_toolbar):
        ...
        viewer_toolbar.addDivider(20, ICON_SIZE + 5, 0)
        viewer_toolbar.addItem(self.brush_none_button, 2)
        ...
        viewer_toolbar.addSpacer(5)
        # viewer_toolbar.addItem(self.brush_settings_button, 4)
        # viewer_toolbar.addSpacer(5)
...
def init_toolbar(tool_info):
    ...
    return AnnotationToolbarHandler(viewer_toolbar)