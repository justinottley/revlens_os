...
public:
    ...
    RLANN_GUI_BrushSizeMenuItem(GUI_ItemBase* parent);
...
public slots:
    ...
    static RLANN_GUI_BrushSizeMenuItem*
    new_RLANN_GUI_BrushSizeMenuItem(GUI_ItemBase* parent)
    {
        return new RLANN_GUI_BrushSizeMenuItem(parent);
    }
