...
RLANN_GUI_AnnotationTrackFactoryPlugin::onSessionChanged(DS_SessionPtr session)
{
    ...
    connect(
        ...
        this,
        &RLANN_GUI_AnnotationTrackFactoryPlugin::onTrackDataChanged
    );
}
...
void
RLANN_GUI_AnnotationTrackFactoryPlugin::onTrackDataChanged(QString eventName, QString trackUuidStr, QVariantMap trackData)
{
    // RLP_LOG_DEBUG(eventName << trackUuidStr);
