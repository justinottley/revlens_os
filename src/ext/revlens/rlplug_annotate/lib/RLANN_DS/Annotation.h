...
typedef QHash<QString, MousePos> StringMousePosMap;
...
public:
    ...
    void update(int width, int height, int yOffset, float displayZoom, float relZoom);
...
public:
    ...
    void setWindow(QString displayUuidStr, int width, int height, int yOffset, float displayZoom, float relZoom);
    QPointF mapToImage(QString displayUuidStr, const QPointF& inPoint, QPointF& panPercent);
    float sizeRatio(QString displayUuidStr);
    ...
    static QImage extractAnnotation(QImage bg, QImage rawAnnotation);
    static QImage flattenAnnotation(QImage bg, QImage rawAnnotation);
...
public slots:
    ...
    QImage imageFromHistory(int idx) { return _history.at(idx); }
    void saveImageToHistory(QImage img) { _history.append(img); }
