...
bool
RLQTDISP_FadeMessagePlugin::setMainController(DS_ControllerBase* controller)
{
...
RLQTDISP_FadeMessagePlugin::displayMessage(QString message, int duration, QString colour)
{
    ...
    if (mc->getPlaybackState() == CNTRL_MainController::PLAYSTATE_PAUSED)
    {
...
RLQTDISP_FadeMessagePlugin::onPlayStateChanged(int playstate)
{
    ...
    if (playstate == CNTRL_MainController::PLAYSTATE_PLAYING)
    {
        msg = "Play";
    } else
    {
