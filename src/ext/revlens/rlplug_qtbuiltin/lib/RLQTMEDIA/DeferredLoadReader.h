...
public:
    ...
    void emitRequestNamedClientCall(
        QString clientName,
        QString method,
        QVariantList args,
        QVariantMap kwargs,
    ...
    {
        emit requestNamedClientCall(clientName, method, args, kwargs, skwargs, callback);
    }

public slots:
    bool loadMedia(QVariantMap srcInfo);

private slots:
    void loadDeferred(DS_Node::NodeDataType dataType=DS_Node::DATA_UNKNOWN);
