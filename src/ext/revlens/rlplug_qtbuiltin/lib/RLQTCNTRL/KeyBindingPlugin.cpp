...
#include "RlpExtrevlens/RLQTCNTRL/KeyBindingPlugin.h"

RLP_SETUP_LOGGER(extrevlens, RLQTCNTRL, KeyBindingPlugin)

RLQTCNTRL_KeyBindingPlugin::RLQTCNTRL_KeyBindingPlugin() :
...
DS_EventPlugin*
RLQTCNTRL_KeyBindingPlugin::duplicate()
{
    // RLP_LOG_DEBUG("")

    return new RLQTCNTRL_KeyBindingPlugin();
}


bool
RLQTCNTRL_KeyBindingPlugin::keyPressEventInternal(QKeyEvent* event)
{
   // RLP_LOG_DEBUG("");
...
bool
RLQTCNTRL_KeyBindingPlugin::keyReleaseEventInternal(QKeyEvent* event)
{
    // RLP_LOG_DEBUG("RLQTCNTRL_KeyBindingPlugin::keyReleaseEvent() with python" << std::endl;
    return false;
}


bool
RLQTCNTRL_KeyBindingPlugin::mousePressEventInternal(QMouseEvent* event)
{
    // RLP_LOG_DEBUG("")
