...
class EXTREVLENS_RLQTCNTRL_API RLQTCNTRL_KeyBindingPlugin : public DS_EventPlugin {
    Q_OBJECT

public:
    RLP_DEFINE_LOGGER

    RLQTCNTRL_KeyBindingPlugin();
...
Q_DECLARE_METATYPE(RLQTCNTRL_KeyBindingPlugin *)
