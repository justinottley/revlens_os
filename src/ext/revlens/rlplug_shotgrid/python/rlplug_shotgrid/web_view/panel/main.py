...
from rlplug_shotgrid import sg_handler
...
class ShotgunSettingsPanel(RlpGui.GUI_ItemBase):
    ...
    def __init__(self, fpane):
        ...
        self.settingsUpdated = QtCore.PY_Signal(self)
    ...
    def on_save_requested(self, md=None):
        ...
        sg_handler.write_site_config(site_config)
...
class ShotgunBrowserPanel(RlpGui.GUI_ItemBase):
    ...
    def on_settings_changed(self, md=None):

        sg_handler.init_sg_revlens()
        self.startup()
    ...
    def on_settings_requested(self, md=None):
        ...
        global G_SETTINGS
        fpane = revlens.GUI.mainView().createFloatingPane(400, 300, False)

        settings_panel = ShotgunSettingsPanel(fpane)
        settings_panel.settingsUpdated.connect(self.on_settings_changed)
