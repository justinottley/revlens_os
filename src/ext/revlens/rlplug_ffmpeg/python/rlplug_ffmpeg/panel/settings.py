...
class FFmpegSettingsPanel(RlpGui.GUI_ItemBase):
    ...
    def __init__(self, parent):
        ...
        self.formats_table = RlpGui.GUI_GRID_View(self, None)
        ...
        self.codecs_table = RlpGui.GUI_GRID_View(self, None)
    ...
    def init(self):
        ...
        self.formats_table.setModelData(result, '', True, True)
        ...
        self.codecs_table.setModelData(result, '', True, True)
