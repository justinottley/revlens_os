...
bool GUI_PaneSplitter::AUTOHIDE = true;
        ...
        _drawLine(true)
{
    ...
    connect(
        this,
        &GUI_PaneSplitter::splitterDragStart,
        myScene,
    ...
    connect(
        this,
        &GUI_PaneSplitter::splitterDragEnd,
        myScene,
...
GUI_PaneSplitter::mouseMoveEvent(QMouseEvent* event)
{
    if (_inDrag)
    {
        ...
        // Turn off live update for linux / teridici, seems to not perform well. Not sure why that is..
        //
        #ifndef __MACH__
        setPosPercent(pos, false);
        #else
        setPosPercent(pos);
        #endif
