...
public slots:
    ...
    void setHoverBgColour(QColor col) { _hoverBgCol = col; }
...
public slots:
    ...
    GUI_ItemBase* contentWrapper() { return _contentWrapper; }
    ...
    void setHScrollBarVisOffset(int offset) { _hScrollbarVisOffset = offset; }
    ...
    void setContentWidthOffset(int woffset) { _contentWidthOffset = woffset; }
