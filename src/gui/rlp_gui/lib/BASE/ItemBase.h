...
public slots:
    ...
    void setItemAcceptsHoverEvents(bool hover) { setAcceptHoverEvents(hover); }
    void setItemClipsChildren(bool val) { setFlag(QQuickItem::ItemClipsChildrenToShape, val); }
    void setItemAcceptsDrops(bool val) { setFlag(QQuickItem::ItemAcceptsDrops, val); }
    ...
    void updateMetadata(QVariantMap md) { _metadata.insert(md); }
    ...
    void setupDragAndDrop(QString label, qreal x, qreal y, QString mimeKey, QString mimeVal);
    bool inDragAndDrop() { return _inDragAndDrop; }
