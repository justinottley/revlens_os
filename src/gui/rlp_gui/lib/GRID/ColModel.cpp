...
GUI_GRID_ColModel::initFormatters()
{
    ...
    _fmtrMap.insert("image_path", new GUI_GRID_CellFormatterImage(
        GUI_GRID_CellFormatterImage::FMT_VAL_PATH));
...
void
GUI_GRID_ColModel::clearData()
{
    // RLP_LOG_DEBUG("")

    GUI_GRID_FormatterBase* fmt = _fmtrMap.value("image_path");
    fmt->clearData();
}
