...
public slots:
    ...
    void addRowWidget(QString name, GUI_GRID_RowWidget* widget);
...
public slots:
    ...
    virtual void setModelValue(QString key, QVariant val) { _rowData->insert(key, val); }
    ...
    void unsetBgColour() { _bgCol = Qt::transparent; }
    void setHighlightColour(QColor col) { _highlightCol = col; }
...
protected:
    ...
    QMap<QString, GUI_GRID_RowWidget*> _widgets;
};
