...
SCAFFOLD_PYMODULE(RlpGuiQTGUI, m) {
    ...
    #ifndef SCAFFOLD_IOS
    py::class_<QPrinter>(m, "QPrinter")
        .def("newPage", &QPrinter::newPage)
    ;
    #endif

    py::class_<QMouseEvent>(m, "QMouseEvent")
        .def("position", &QMouseEvent::position)
        .def("globalPosition", &QMouseEvent::globalPosition)
        .def("scenePosition", &QMouseEvent::scenePosition)
        .def("setAccepted", &QMouseEvent::setAccepted)
        .def("modifiers",
            [](QMouseEvent& m) {
        ...
        .def("leftButton",
            [](QMouseEvent& m) {
                return (bool)(m.buttons() & Qt::LeftButton);
            })
        .def("rightButton",
            [](QMouseEvent& m) {
                return (bool)(m.buttons() & Qt::RightButton);
            })
    ;
    ...
    py::class_<QDragEnterEvent>(m, "QDragEnterEvent")
        .def("mimeData", &QDragEnterEvent::mimeData, py::return_value_policy::reference)
        .def("setAccepted", &QDragEnterEvent::setAccepted)
    ;

    py::class_<QDragLeaveEvent>(m, "QDragLeaveEvent")
        .def("setAccepted", &QDragLeaveEvent::setAccepted)
    ;

    py::class_<QDropEvent>(m, "QDropEvent")
        .def("mimeData", &QDropEvent::mimeData, py::return_value_policy::reference)
    ;
    ...
    py::class_<QQuickItem, QObject>(m, "QQuickItem")
        ...
        .def("parentItem", &QQuickItem::parentItem, py::return_value_policy::reference)
        .def("setVisible", &QQuickItem::setVisible)
        .def("isVisible", &QQuickItem::isVisible)
        .def("width", &QQuickItem::width)
        .def("height", &QQuickItem::height)
        .def("setWidth", &QQuickItem::setWidth)
        .def("setHeight", &QQuickItem::setHeight)
        .def("setOpacity", &QQuickItem::setOpacity)
        .def("setParentItem", &QQuickItem::setParentItem)
        .def("x", &QQuickItem::x)
        .def("y", &QQuickItem::y)
        .def("z", &QQuickItem::z)
    ...
    py::class_<QQuickWindow>(m, "QQuickWindow")
        .def("width", &QQuickWindow::width)
        .def("height", &QQuickWindow::height)
        .def("show", &QQuickWindow::show)
        .def("setScreen", &QQuickWindow::setScreen)
        .def("setGeometry",
            static_cast<void (QQuickWindow::*)(const QRect&)>(&QQuickWindow::setGeometry)
        )
    ...
    py::class_<QScreen>(m, "QScreen")
        .def("geometry", &QScreen::geometry)
        .def("availableGeometry", &QScreen::availableGeometry)
        .def("name",
            [](const QScreen& s) {
                return s.name().toStdString();
            }
        )
    ;

    py::class_<QApplication>(m, "QApplication")
        .def_static("instance", &QApplication::instance, py::return_value_policy::reference)
        .def("screens",
